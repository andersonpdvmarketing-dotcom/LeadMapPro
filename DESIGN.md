...
| Texto `--text` / `-2` / `--muted` / `--faint` | `#171a21` / `#3f4654` / `#5d6675` / `#79818f` | `#e9ebf0` / `#c4c9d4` / `#9aa3b2` / `#737d8d` |
...
**Nichos** (a única cor "de marca", pertence aos dados): imobiliário `#2563eb` · saúde `#0d9488` · estética `#db2777` · automóvel `#ea580c` · personalizado `#7c3aed`; cada um com par texto/tint (`--n-*-t`, `--n-*-bg`) e variantes escuras. Sincronizar sempre com `NICHES` no JS.
